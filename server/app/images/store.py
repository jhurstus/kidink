...
# app/countdown/hero.py, app/joke/hero.py, and app/images/strip_icons.py.
#
...
# drawn inside the image; the §9 day-strip panel art, full-bleed cover-fit):
# skip the chroma keying and the crop-to-visible pass — the raw generation
# bytes are stored verbatim.
_UNKEYED_MODULES = frozenset({"Countdown", "Joke", "DayStrip"})
...
_EDIT_FROM_BASE = frozenset({("Countdown", "excited"), ("DayStrip", "excited")})
