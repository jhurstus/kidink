...
# app/countdown/hero.py.
#
# Modules whose prompts ask for a solid white background and whose images are
# displayed as-is (the §12 countdown hero): skip the chroma keying and the
# crop-to-visible pass — the raw generation bytes are stored verbatim.
_UNKEYED_MODULES = frozenset({"Countdown"})
